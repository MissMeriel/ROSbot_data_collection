...
def generate_launch_description():
    ...
    dest_launch_arg = DeclareLaunchArgument("dest", default_value=TextSubstitution(text="/home/husarion/media/usb9_23_onnxtransformer"))
    ...
    return LaunchDescription([
        ...
        Node(
            package='final',
            executable='onnx_steering_NN_transformer',
            name='sim',
            parameters=[
