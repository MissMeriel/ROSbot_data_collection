...
python3 train_DAVE2.py  /p/rosbot/rosbotxl/data-yili/cleaned/mecanum_wheels/rosbotxl_off_4 --batch 32 --lossfxn MSE --archid DAVE2v3 --convergence --robustification --slurmid $SLURM_JOB_ID