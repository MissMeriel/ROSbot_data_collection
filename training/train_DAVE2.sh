...
python3 train_DAVE2.py  /p/rosbot/rosbotxl/data-yili/cleaned/mecanum_wheels/rosbotxl_off_4  --batch 32 --lossfxn L1 --archid DAVE2v3 --robustification --convergence --slurmid $SLURM_JOB_ID
