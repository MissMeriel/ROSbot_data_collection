...
def main_loop():
    ...
    try:
        with open(dataset_subdir+"/data.csv", "w") as f:
            ...
            f.write("IMAGE,IMAGE_HEADER_TIME,ROS_TIME,CMD_VEL_LAT,CMD_VEL_LONG,VELOCITY_LIN_X,VELOCITY_ANG_Z,BATT_VOLTAGE,LIDAR_ANGLE_MIN,LIDAR_ANGLE_MAX,LIDAR_ANGLE_INCREMENT,LIDAR_RANGE_MIN,LIDAR_RANGE_MAX,LIDAR_RANGE,LIDAR_INTENSITY,RANGE_FL,RANGE_FR,RANGE_RL,RANGE_RR\n")
