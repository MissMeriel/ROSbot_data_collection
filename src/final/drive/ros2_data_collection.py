...
class DataCollectionNode(Node):
    def __init__(self):
        ...
        with open(self.dataset_path, 'a') as f:
            f.write("{},{},{},{},{}\n".format("image name", "linear_speed_x", "angular_speed_z", "is_turning", "lidar_ranges"))
    ...
    def timer_callback(self):
        ...
        cv2.imwrite(f"{self.parent_path}/{self.dataset_subdir_id}/{self.dataset_subsubdir_id}/{image_filename}",
                    self.bridged_image[:, :, ::-1])
        with open(self.dataset_path, 'a') as f:
            ...
            f.write(
                "{},{},{},{},{}\n".format(image_filename, self.linear_speed_x, self.angular_speed_z, self.is_turning,
                                          stringified_lidar_ranges))
    ...
    def vel_cmd_callback(self, msg):
        ...
        # Test through logger
        # self.get_logger().info(f"Velocity command received: linear_speed_x={self.linear_speed_x}, angular_speed_z={self.angular_speed_z}, is_turning={self.is_turning}")
